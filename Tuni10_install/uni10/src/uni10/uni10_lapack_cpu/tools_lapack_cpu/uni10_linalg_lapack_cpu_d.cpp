...
namespace uni10{
  ...
  namespace uni10_linalg{
    ...
    void vectorMul(double* Y, double* X, uni10_uint64 N){ // Y = Y * X, element-wise multiplication;
    ...
    void trimatrixEigH(double* D, double* E, uni10_int N, 
    ...
    void matrix_diag_dense_mul(const double* D, const double* a, uni10_uint64 m, uni10_uint64 n, double* v){
    ...
    void matrix_dense_diag_mul(const double* a, const double* D, uni10_uint64 m, uni10_uint64 n, double* v){
