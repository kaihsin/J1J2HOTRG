...
namespace uni10{
  ...
  namespace uni10_linalg{
    ...
    //LAPACK
    //
    void matrixSVD(std::complex<double>* Mij_ori, uni10_int M, uni10_int N, std::complex<double>* U, std::complex<double>* S_ori, std::complex<double>* vT){
    ...
    void matrixSDD(std::complex<double>* Mij_ori, uni10_int M, uni10_int N, std::complex<double>* U, std::complex<double>* S_ori, std::complex<double>* vT){

      uni10_int min = std::min(M, N);
      double* S = (double*)malloc(min * sizeof(double));
      matrixSDD(Mij_ori, M, N, U, S, vT);
      uni10_elem_cast(S_ori, S, min);
      free(S);
    ...
    void matrix_diag_dense_mul(const std::complex<double>* D, const std::complex<double>* a, uni10_uint64 m, uni10_uint64 n, std::complex<double>* v){
    ...
    void matrix_dense_diag_mul(const std::complex<double>* a, const std::complex<double>* D, uni10_uint64 m, uni10_uint64 n, std::complex<double>* v){
