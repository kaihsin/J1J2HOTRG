...
namespace uni10{
  ...
  namespace uni10_linalg{
    ...
    void vectorAdd_cpu(double a, double* X, uni10_int incx, std::complex<double>* Y, uni10_int incy, uni10_uint64 N){   // Y = aX + Y
      uni10_uint64 x_idx = 0;
      for(uni10_uint64 i = 0; i < N; i+=incy){
        Y[i] += a * X[x_idx];
        x_idx += incx;
      }
    }

    void vectorAdd_cpu(std::complex<double>* Y, double* X, uni10_uint64 N){
      for(uni10_uint64 i = 0; i < N; i++)
        Y[i] += X[i];
    }

    void vectorSub_cpu(std::complex<double>* Y, double* X, uni10_uint64 N){
      for(uni10_uint64 i = 0; i < N; i++)
        Y[i] -= X[i];
    }

    void vectorMul_cpu(std::complex<double>* Y, double* X, uni10_uint64 N){
      for(uni10_uint64 i = 0; i < N; i++)
        Y[i] *= X[i];
    }

    void vectorScal_cpu(double a, std::complex<double>* X, uni10_uint64 N){
    ...
    void vectorExp_cpu(double a, std::complex<double>* X, uni10_uint64 N){
      for(uni10_uint64 i = 0; i < N; i++)
        X[i] = std::exp(a * X[i]);
    }

    void matrixDot_cpu(double* A, std::complex<double>* B, uni10_int M, uni10_int N, uni10_int K, std::complex<double>* C){
    ...
    void matrixDot_cpu(std::complex<double>* A, double* B, uni10_int M, uni10_int N, uni10_int K, std::complex<double>* C){
    ...
    void diagRowMul_cpu(std::complex<double>* mat, double* diag, uni10_uint64 M, uni10_uint64 N){
      for(uni10_uint64 i = 0; i < M; i++)
        vectorScal_cpu(diag[i], &(mat[i * N]), N);
    }

    void diagColMul_cpu(std::complex<double>* mat, double* diag, uni10_uint64 M, uni10_uint64 N){
      for(uni10_uint64 i = 0; i < M; i++){
    ...
    void eigDecompose_cpu(double* Kij_ori, uni10_int N, std::complex<double>* Eig, std::complex<double>* EigVec){
    ...
    void eigSyDecompose_cpu(std::complex<double>* Kij, uni10_int N, double* Eig, std::complex<double>* EigVec){
    ...
    void matrixSVD_cpu(std::complex<double>* Mij_ori, uni10_int M, uni10_int N, std::complex<double>* U, double *S, std::complex<double>* vT){
    ...
    void matrixSDD_cpu(std::complex<double>* Mij_ori, uni10_int M, uni10_int N, std::complex<double>* U, double *S, std::complex<double>* vT){
    ...
    void matrix_diag_dense_mul_cpu(const double* D, const std::complex<double>* a, uni10_uint64 m, uni10_uint64 n, std::complex<double>* v){
    ...
    void matrix_dense_diag_add_cpu(const double* a, const std::complex<double>* D, uni10_uint64 m, uni10_uint64 n, std::complex<double>* b){
      ...
      uni10_elem_cast(b, a, m*n, false, false);
      uni10_uint64 min = std::min(m, n);
      uni10_uint64 i;
      for( i = 0; i < min; i++)
        b[i*n+i] += D[i];
    ...
    void matrix_dense_diag_mul_cpu(const double* a, const std::complex<double>* D, uni10_uint64 m, uni10_uint64 n, std::complex<double>* v){
    ...
    void matrix_diag_dense_sub_cpu(const std::complex<double>* D, const double* a, uni10_uint64 m, uni10_uint64 n, std::complex<double>* b){
      ...
      uni10_uint64 elemNum = m*n;
      uni10_elem_cast(b, a, elemNum, false, false);
      vectorScal_cpu(-1., b, elemNum);
    ...
    void matrix_diag_dense_mul_cpu(const std::complex<double>* D, const double* a, uni10_uint64 m, uni10_uint64 n, std::complex<double>* v){
    ...
    void matrix_dense_diag_mul_cpu(const std::complex<double>* a, const double* D, uni10_uint64 m, uni10_uint64 n, std::complex<double>* v){
