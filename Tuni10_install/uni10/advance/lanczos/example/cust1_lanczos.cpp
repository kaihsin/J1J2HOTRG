...
int main(){
  ...
  uni10_lanczos_custom1_paras<uni10_double64> cust1_paras(EnvL, WL, WR, EnvR, l_net, V);
  uni10_lanczos_paras<uni10_double64, uni10_lanczos_custom1_paras<uni10_double64> > l_paras(cust1_paras);

  uni10_uint64 iter=0;

  int info;
  double E = Lanczos(l_paras, iter, 10, 2, info);
