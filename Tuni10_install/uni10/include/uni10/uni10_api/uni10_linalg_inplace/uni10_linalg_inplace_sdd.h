...
namespace uni10{
  ...
  template<typename uni10_type>
    void sdd( const Block<uni10_type>& Mij, Matrix<uni10_type>& U, Matrix<uni10_type>& S, Matrix<uni10_type>& vT, UNI10_INPLACE on );
  ...
  template<typename uni10_type>
    void sdd( const Block<uni10_type>& Mij, Matrix<uni10_type>& U, Matrix<uni10_type>& S, Matrix<uni10_type>& vT, UNI10_INPLACE on ){
      ...
      matrixSDD(&Mij.elem, &Mij.diag, &Mij.Rnum, &Mij.Cnum, U_elem, &S.elem, vT_elem);
