...
namespace uni10{
  ...
  template <typename _uni10_type>
    void resize(uni10_elem_cusolver_gpu<_uni10_type>& Eout, uni10_uint64 _row, uni10_uint64 _col, 
        const uni10_elem_cusolver_gpu<_uni10_type>& Ein, const uni10_uint64 _Rnum, const uni10_uint64 _Cnum, uni10_const_bool& _fixHead);
      ...
      if(_fixHead){
        ...
        if(isdiag){
          ...
          if(_elemNum > Ein.__elemNum){
            ...
            uni10_elem_copy(Eout.__elem, Ein.__elem, Ein.__elemNum * sizeof(_uni10_type), Eout.__ongpu, Ein.__ongpu);

          }
          else
            uni10_elem_copy(Eout.__elem, Ein.__elem, Eout.__elemNum * sizeof(_uni10_type), Eout.__ongpu, Ein.__ongpu);
